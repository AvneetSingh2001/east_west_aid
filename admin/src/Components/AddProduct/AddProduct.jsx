...
const AddProduct = () => {
  ...
  const Add_Product = async () => {
    ...
    await fetch('https://east-west-aid.onrender.com/upload', {
      method: 'POST',
      headers: {
    ...
    if (responseData.success) {
      ...
      await fetch('https://east-west-aid.onrender.com/uploadMultiple', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
        },
      ...
      await fetch('https://east-west-aid.onrender.com/addproduct', {
        method: 'POST',
        headers: {
          Accept: 'application/json',
